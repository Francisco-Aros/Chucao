...
st.write("Para obtener más información sobre el Chucao, visita la página web de [Aves de Chile](https://www.avesdechile.cl/174.htm) en la cual podrán encontrar información detallada de esta y otras aves.", allow_markdown=True)

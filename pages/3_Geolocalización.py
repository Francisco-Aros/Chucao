...
def filtrar_por_meses(df, meses):
    # convierte los meses seleccionados en una lista de enteros
    meses_seleccionados = [int(m) for m in meses]

    # extrae el mes de la columna fecha y lo compara con los meses seleccionados
    df_filtrado = df[df['fecha'].dt.month.isin(meses_seleccionados)]
